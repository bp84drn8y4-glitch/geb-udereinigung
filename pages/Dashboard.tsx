...
// Import the new logo
import fuerstHauserLogo from '../assets/logos/fuerst-hauser-logo.png';
...
const Dashboard: React.FC<DashboardProps> = ({ onNavigate, protocols, customers, userType }) => {
    ...
    return (
        <div className="space-y-8">
            ...
            <div>
                <h2 className="text-2xl font-semibold mb-6 text-sky-800 dark:text-sky-300 text-center">
                    Dashboard
                </h2>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg border border-transparent dark:border-slate-700/50">
                 <h2 className="text-2xl font-semibold mb-6 text-sky-800 dark:text-sky-300 border-b border-slate-200 dark:border-slate-700 pb-4">
                    Leistungsübersicht (Aktueller Monat)
                 </h2>
